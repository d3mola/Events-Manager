...
echo '"/var/jenkins_home/workspace/Events-Manager" directory),'
...
echo 'Now...'
echo 'Visit http://localhost:8080 to see your Node.js/React application in action.'
echo '(This is why you specified the "args ''-p 8080:8080''" parameter when you'
